    ...
    <div ref={containerRef} className="relative w-full">
      ...
      <div className="relative">
        <input
          ...
          onKeyDown={onKeyDown}
          className="w-full bg-black/60 border border-white/20 rounded-md px-4 py-3 text-white text-base sm:text-lg placeholder:text-mta-gray/70 focus:outline-none focus:border-mta-amber focus:ring-2 focus:ring-mta-amber/40"
          autoComplete="off"
          spellCheck={false}
        />
        {open && (
            ...
            results.map((s, i) => (
              ...
              >
                ...
                {selectedStationId === s.gtfsStopId && (
                  <span className="text-mta-amber text-xs uppercase tracking-wider shrink-0">
                    Selected
                  </span>
                )}
              </li>
